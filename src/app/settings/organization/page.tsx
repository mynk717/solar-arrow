...
useEffect(() => {
  ...
  <div>
    <label className="block text-sm font-semibold text-gray-900 mb-2">Telegram Group</label>
    {org.telegramGroupChatId ? (
      <div className="flex items-center gap-2">
        <span className="inline-flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full font-semibold bg-blue-50 text-blue-700">
          <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121l-6.869 4.326-2.96-.924c-.64-.203-.658-.64.135-.954l11.566-4.458c.538-.196 1.006.128.832.941z"/>
          </svg>
          Connected
        </span>
        <code className="text-xs text-gray-500 bg-gray-100 px-2 py-0.5 rounded">{org.telegramGroupChatId}</code>
      </div>
    ) : (
      <a href="/settings/telegram" className="text-xs text-orange-600 font-medium hover:underline">
