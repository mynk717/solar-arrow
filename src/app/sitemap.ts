...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: 'https://sa.mktgdime.com/features',  lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    { url: 'https://sa.mktgdime.com/pricing',   lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    { url: 'https://sa.mktgdime.com/demo',      lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
