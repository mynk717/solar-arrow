  ...
  return (
    <div className="max-w-4xl mx-auto p-8 py-12">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">About Solar Arrow</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">When you use Solar Arrow, we collect and process:</p>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Google API Services Disclosure</h2>
        <p className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">Solar Arrow integrates with:</p>
        <ul className="list-disc ml-6 mb-4">
          <li><strong>Google Sheets API</strong> - for data storage</li>
          <li><strong>Google Drive API</strong> - for sheet management</li>
        </ul>
        <p>Your use of these services is also subject to Google's privacy policies.</p>
      </section>

      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Contact Us</h2>
        <p className="mb-2">If you have questions about this privacy policy:</p>
        <p className="mb-2"><strong>Email:</strong> shukla.mayank247@gmail.com</p>
        <p className="mb-2"><strong>App:</strong> Solar Arrow by Marketing Dime</p>
        <p><strong>Website:</strong> <a href="https://sa.mktgdime.com" className="text-blue-600 hover:underline">sa.mktgdime.com</a></p>
      </section>
    </div>
  )
}
